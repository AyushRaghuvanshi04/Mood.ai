...
export async function POST(req: Request) {
	...
	try {
		...
		const system = `You are a music curator expert. Generate ${requestedSongs} real, popular songs that match the given vibe/mood and criteria. Return ONLY a minified JSON object with this exact shape: {"tracks":[{"title":"Song Title","artist":"Artist Name"}]}. Use real, well-known songs and artists that are likely to be available on Spotify. Do not include markdown, code blocks, or extra text.`;
